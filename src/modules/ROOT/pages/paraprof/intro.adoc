...
ParaProf is a java program that is run from the supplied paraprof script ( script (paraprof.bat for windows binary release). for windows binary release).
...
:leveloffset: +1
include::../perfdmf/dataformats.adoc[]
:leveloffset: -1
...
* --fixnames - Use the fixnames option
